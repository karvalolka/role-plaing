    ...
    <div class="container" style="width: 100%; padding-left: 0; padding-right: 0;">
        ...
        <div class="works-content" style="display: flex; justify-content: center; flex-wrap: wrap; gap: 20px;">
            @foreach($freePoints as $freePoint)
                <div class="single-blog-item" style="text-align: center; width: 300px; margin-bottom: 30px; overflow: hidden; max-height: 450px;">
                    <div class="single-blog-item-img">
                        <img src="{{asset('assets/images/blog/b1.jpg')}}" alt="blog image" style="width: 100%; height: auto;">
                    </div>
